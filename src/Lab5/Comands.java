...
public abstract class Comands {
    ...
    public static void add(PriorityQueue<Product> pq) {
        ...
        try {
            ...
            try {
                person.setNationality(Country.valueOf(scanner.nextLine()));
                product.setOwner(person); } catch (Exception ex){
                ex.printStackTrace();
            }
        }
        try {
            ...
            System.out.println("Попробуйте заново ввести единицу измерения");
            try {
                product.setUnitOfMeasure(UnitOfMeasure.valueOf(scanner.nextLine())); } catch (Exception ex){
                ex.printStackTrace();
            }
        }
        product.setCreationDate(new Date());
    ...
    public static void addE(PriorityQueue<Product> pq) throws IOException {
       FileReader fr = new FileReader("C:\\\\Users\\\\User\\\\Desktop\\\\test.txt");
        ...
        try {
            person.setWeight(Double.parseDouble(reader.readLine()));
            } catch (Exception ex){
                ex.printStackTrace();
            }
        try {
    ...
    public static void execute_script(PriorityQueue<Product> pq) {
        ...
        try {
            ...
            //String str1 = sc.nextLine();
                ...
                //File file = new File(str1);//C:\\Users\\User\\Desktop\\test.txt"
            try {
                FileReader fr = new FileReader("C:\\Users\\User\\Desktop\\test.txt");//home/s263879/5/test.txt"
                Object[] products = pq.toArray();
                boolean exit = true;
                ...
                while (exit) {
                    ...
                    switch (line.toLowerCase()) {
                        ...
                        case ("help"):
                            ...
                            break;
                        case ("remove_greater"):
                            Comands.remove_greater(pq);
                            break;
                        case ("add_if_max"):
                            Comands.add_if_max(pq);
                            break;
                        case ("filter_greater_than_price"):
                            try {
                                Comands.filter_greater_than_price(pq);
                        ...
                        case ("count_less_than_price"):
                            try {
                                Comands.count_less_than_price(pq);
                            } catch (NumberFormatException e) {
                                System.err.println("Вы не ввели значение price, из-за этого сравнение невозможно");
                            }
                            break;
                ...
                System.out.println("Не получается найти ваш файл");
                System.out.println("Проверьте правильность написания пути к файлу");
